...
class ArrayUtil {
	...
	public static function counts($list) {
	...
	/* Return all of the keys in an array as a sequential array. */
	 ...
	 * strict. */
	public static function contains_value($array, $value) {
	...
	/* Prepend a value onto the beginning of an array. */
